...
int _chainHull_2D(intpair_t *points, int n, intpair_t *hull) {
...
IMAGE *_u32_chull(IMAGE *ilbl, int graph) {
...
IMAGE *_chull(IMAGE *ilbl, int graph) {
    switch (GetImDataType(ilbl)) {

    case t_UINT32:
        return _u32_chull(ilbl, graph);
        break;
